...
class HomeComponent {
    ...
    getUsers() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const callResp = yield fetch('https://api.github.com/users?since=1')
                .then((resp) => { resp.json(); });
            return callResp;
        });
    }
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 22, vars: 0, consts: [[1, "main-container"], [1, "Rtable", "Rtable--2cols"], [1, "Rtable-cell", 2, "order", "1"], [1, "Rtable-cell", 2, "order", "2"], [1, "Rtable-cell", 2, "order", "3"], [1, "Rtable-cell", 2, "order", "4"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! /Users/navin/Documents/Development/UI/assignment-angular/application/src/main.ts */"./src/main.ts");
